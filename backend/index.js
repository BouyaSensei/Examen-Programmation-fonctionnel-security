...
app.all('/products', (req, res) => {
    if (req.method === 'GET') {
        ...
        const {product_name, product_description, price, category, image} = req.body; // Remplacez imagePath par image
        connection.query(
...
app.get('/stats', (req, res) => {
    connection.query('SELECT Catégorie, COUNT(*) as Nombre FROM produit GROUP BY Catégorie', (err, results) => {
        if (err) {
